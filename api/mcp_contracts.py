...
TOOL_CONTRACTS = {
    ...
    "knowledge_graph": ToolContract("knowledge_graph", None, "Evidence graph com proveniência", "knowledge.graph", 60.0, "tool_knowledge_graph"),
    ...
    "production_gate": ToolContract("production_gate", None, "Gate único de liberação para produção", "admin.evaluation", 120.0, "tool_production_gate"),
