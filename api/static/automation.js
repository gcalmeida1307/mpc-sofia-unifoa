...
async function approve(id){await sofia.api(`/auth/admin/access-requests/${id}/approve`,{method:'POST'});location.reload()}async function revoke(id){await sofia.api(`/auth/admin/users/${id}/revoke-sessions`,{method:'POST'});alert('Sessões revogadas')}
